...
CREATE INDEX idx_hospitals_province_id ON HOSPITALS(PROVINCE_ID)
...
CREATE INDEX idx_doctors_hos_id ON DOCTORS(HOS_ID)
CREATE INDEX idx_doctors_dept_id ON DOCTORS(DEPT_ID)
CREATE INDEX idx_doctors_proff_id ON DOCTORS(PROFF_ID)
...
CREATE INDEX idx_nurses_hos_id ON NURSES(HOS_ID)
CREATE INDEX idx_nurses_dept_id ON NURSES(DEPT_ID)
...
CREATE INDEX idx_appointments_doc_id ON APPOINTMENTS(DOC_ID)
CREATE INDEX idx_appointments_app_date ON APPOINTMENTS(APP_DATE)
...
CREATE INDEX idx_patients_appointments_pat_id ON PATIENTS_APPOINTMENTS(PAT_ID)
CREATE INDEX idx_patients_appointments_app_id ON PATIENTS_APPOINTMENTS(APP_ID)
...
CREATE INDEX idx_bills_pat_id ON BILLS(PAT_ID)
...
CREATE INDEX idx_receptionists_hos_id ON RECEPTIONISTS(HOS_ID)
...
CREATE INDEX idx_receptionists_records_recep_id ON RECEPTIONISTS_RECORDS(RECEP_ID)
CREATE INDEX idx_receptionists_records_record_id ON RECEPTIONISTS_RECORDS(RECORD_ID)
...
CREATE INDEX idx_doctors_patients_doc_id ON DOCTORS_PATIENTS(DOC_ID)
CREATE INDEX idx_doctors_patients_pat_id ON DOCTORS_PATIENTS(PAT_ID)
...
CREATE INDEX idx_teams_doc_id ON TEAMS(DOC_ID)
CREATE INDEX idx_teams_nur_id ON TEAMS(NUR_ID)
...
CREATE INDEX idx_patient_medications_pat_id ON PATIENT_MEDICATIONS(PAT_ID)
CREATE INDEX idx_patient_medications_med_id ON PATIENT_MEDICATIONS(MED_ID)
...
CREATE INDEX idx_patient_procedures_pat_id ON PATIENT_PROCEDURES(PAT_ID)
CREATE INDEX idx_patient_procedures_proc_id ON PATIENT_PROCEDURES(PROC_ID)
